...
<form class="form-horizontal" action="{{ URL::route('account.error.post') }}" method="POST">
    {{ csrf_field() }}
    <div class="container">
        <div class="login-box card row align-items-center col-12 col-sm-10 col-md-8 col-lg-6">
            <div class="card-header col-12 row justify-content-center">
                <div class="col-12 row justify-content-center"><h2>ERROR</h2></div>
                <div class="col-12 row justify-content-center"><span class="lead">Vuelve a intentarlo</span></div>
            </div>

                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    @foreach ($cliente as $cli)
                                        <tr>
                                            <th scope="row" class="align-middle"><div class="d-flex align-items-center"><img src="{{ asset('assets/img/producto-icon.jpg') }}" alt="..." class="thumbnail border-top border-bottom border-right border-left"><div>{{$cli->nombres}} {{$cli->apaterno}} {{$cli->amaterno}} (30)<small class="d-flex justify-content-start">{{$cli->email}} / {{$cli->movil}}</small></div></div></th>

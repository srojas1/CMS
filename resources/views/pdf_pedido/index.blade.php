@foreach ($pedido as $nkey=>$ped)
	<div>
		...
		<span><b>Fecha de pedido:</b></span> {{formatTimeText($ped->fecha_pedido)}}</span>
		<div class="row justify-content-start align-items-center pt-4">
			<div class="col-4">
				<div class="btn-group">
					@if ($ped->getStatusById->estado)
						<b>Estado:</b> {{$ped->getStatusById->estado}}
					@else
						...
						<table class="table table-hover table-borderless">
							...
							@foreach($ped->getProductsById as $prod)
								<tr>
									...
									<td><div class="d-inline-flex"><img width="50" height="50"  class="pedido_imagen" src="" alt="..." class="producto-icon border-top border-bottom border-right border-left">{{$prod->producto}}</div></td>
							...
							<tr class="border-bottom">
								<td></td>
								<td><div class="d-inline-flex"><i class="producto-icon material-icons"></i>DESCUENTO: [Nombre descuento]</div></td>

...
Route::post('validar_cliente_password','APIController@ValidarClienteUsuarioPassword');
Route::post('validar_cliente','APIController@ValidarCliente');
Route::post('registrar_cliente','APIController@RegistrarCliente');
Route::post('actualizar_cliente','APIController@ActualizarDatosCliente');
Route::post('listar_promociones_imagen','APIController@ListarPromocionesImagen');

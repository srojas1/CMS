...
class Districts extends AbstractModel implements HasPresenter {
     ...
     * @var array
     */
    protected $keepRevisionOf = ['distrito'];
    ...
    {
        return 'GrahamCampbell\BootstrapCMS\Presenters\DistrictPresenter';
    }

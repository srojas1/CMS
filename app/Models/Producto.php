...
class Producto extends AbstractModel implements HasPresenter {
	 ...
	 * @var array
	 */
	public static $index = ['id','producto','codigo','descripcion','categoria_id','id_stock','precio','oferta','imagen_principal','imagenes','vinculacion','visibilidad','SKU','id_usuario'];
	...
	public function getAttributesById() {
		return $this->belongsToMany(Atributo::class,'atributo_producto')->withPivot('id','deleted_at');
	}

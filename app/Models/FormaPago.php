...
class FormaPago extends AbstractModel implements HasPresenter {
     ...
     * @var array
     */
    protected $keepRevisionOf = ['forma_pago'];
     ...
     * @var array
     */
    public static $index = ['id','forma_pago'];
    ...
    {
        return 'GrahamCampbell\BootstrapCMS\Presenters\FormaPagoPresenter';
    }
